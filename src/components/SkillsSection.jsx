...
const skills = [
  ...
  { name: "Kotlin", level: 75, category: "backend" },
  { name: "Swift", level: 65, category: "backend" },
  ...
  { name: "SAP", level: 60, category: "tools" },
  { name: "Microsoft Power Apps", level: 70, category: "tools" },
